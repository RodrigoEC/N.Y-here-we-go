...
export const Checked = ({ checked, onClick }) => {
    const { theme } = useTheme();

    return (
        <svg onClick={onClick} style={{ cursor: "pointer" }} width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
